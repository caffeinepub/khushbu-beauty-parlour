    ...
    extend: {
      ...
      colors: {
        ...
        admin: {
          ...
          "primary-hover": "oklch(var(--admin-primary-hover))",
          "card-bg": "oklch(var(--admin-card-bg))",
        },
        rose: {
          parlour: "oklch(0.63 0.09 22)",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        card: "0 4px 24px 0 rgba(42,26,22,0.10)",
        header: "0 2px 12px 0 rgba(42,26,22,0.10)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
